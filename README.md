...
- **Portail Développeur (Backstage)** : Accessible sur `http://localhost:7007` (après avoir lancé `make dev`).
- **Documentation Technique (MkDocs)** : Accessible sur `http://localhost:5000`.
