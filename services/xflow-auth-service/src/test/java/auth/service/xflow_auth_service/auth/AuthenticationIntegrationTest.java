...
public class AuthenticationIntegrationTest extends BaseIntegrationTest {
    ...
    class PublicAuthenticationTests {
        ...
        @Test
        @DisplayName("POST /auth/login - Identifiants Invalides (401 via ExceptionHandler)")
        ...
        @Test
        @DisplayName("POST /auth/login/operator - Succès")
        void loginOperator_Success() throws Exception {
            ...
            mockMvc.perform(post("/auth/login/operator")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk())
        ...
        @Test
        @DisplayName("POST /auth/login/anonymous - Succès avec Fingerprint")
        void loginAnonymous_Success() throws Exception {
            ...
            mockMvc.perform(post("/auth/login/anonymous")
        ...
        @Test
        @DisplayName("POST /auth/refresh - Succès")
    ...
    class SecuredAuthenticationTests {
        ...
        @Test
        @DisplayName("GET /auth/me - Absent de Jeton (401 intercepté par GlobalExceptionHandler)")
        ...
        @DisplayName("GET /auth/me - Connecté (Succès)")
        ...
        @Test
        @DisplayName("PUT /auth/me/password - Absent de Jeton (401)")
        ...
        @Test
        @WithMockUser(username = "igor@xflow.com")
        @DisplayName("PUT /auth/me/password - Connecté (Succès)")
        ...
        @Test
        @WithMockUser(username = "igor@xflow.com")
        @DisplayName("PUT /auth/me/pin - Connecté (Succès)")
        ...
        @DisplayName("PUT /auth/operator/{id}/regenerate-credentials - Rôle Insuffisant (403 via ExceptionHandler)")
        void regenerateCredentials_InsufficientRole_Returns403() throws Exception {
            UUID targetId = UUID.randomUUID();

            mockMvc.perform(put("/auth/operator/" + targetId + "/regenerate-credentials")
                    .accept(MediaType.APPLICATION_JSON))
        ...
        @DisplayName("PUT /auth/operator/{id}/regenerate-credentials - Rôle Admin (Succès)")
